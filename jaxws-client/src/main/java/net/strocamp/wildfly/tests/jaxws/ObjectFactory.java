 ...
 * generated in the net.strocamp.wildfly.tests.jaxws package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://jaxws.tests.wildfly.strocamp.net/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://jaxws.tests.wildfly.strocamp.net/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.strocamp.wildfly.tests.jaxws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.tests.wildfly.strocamp.net/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws.tests.wildfly.strocamp.net/", name = "getHelloWorldAsString")
